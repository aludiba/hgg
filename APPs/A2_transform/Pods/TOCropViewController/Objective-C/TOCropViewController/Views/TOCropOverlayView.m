...
- (void)layoutLines
{
    ...
    for (NSInteger i = 0; i < 4; i++) {
        ...
        switch (i) {
            case 0: frame = (CGRect){0,-1.0f,boundsSize.width+2.0f, 1.0f}; break; 
            case 1: frame = (CGRect){boundsSize.width,0.0f,1.0f,boundsSize.height}; break; 
            case 2: frame = (CGRect){-1.0f,boundsSize.height,boundsSize.width+2.0f,1.0f}; break; 
            case 3: frame = (CGRect){-1.0f,0,1.0f,boundsSize.height+1.0f}; break; 
        }
