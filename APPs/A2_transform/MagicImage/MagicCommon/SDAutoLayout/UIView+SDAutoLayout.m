...
- (void)sd_resizeWithModel:(SDAutoLayoutModel *)model
{
    ...
    if (view.sd_maxWidth && (model.rightSpaceToView || model.rightEqualToView)) { 
    ...
    if (view.autoHeightRatioValue && view.width_sd > 0 && (model.bottomEqualToView || model.bottomSpaceToView)) { 
