...
- (BOOL)getRGBHex:(unsigned int*)rgbHex
{
    ...
    if (numComponents == 4)
    {
        CGFloat rFloat = components[0]; 
        CGFloat gFloat = components[1]; 
        CGFloat bFloat = components[2]; 
